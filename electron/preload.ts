...
const mobileApi = {
  ...
  pairWifi: (endpoint: string, code: string) => ipcRenderer.invoke("mobile:pair-wifi", { endpoint, code }) as Promise<string>,
  enableUsbWifi: (serial: string) => ipcRenderer.invoke("mobile:enable-usb-wifi", serial) as Promise<string>,
