...
export const widgets: WidgetConfig[] = [
  ...
  { id: "planning", title: "Third-Party Presentation - Canva", type: "presentation", icon: "P", x: 1540, y: 1080, width: 1240, height: 760, accent: "violet", source: { url: "https://canva.link/pvfuqc2u2ak3f4j", label: "Canva presentation" } },
